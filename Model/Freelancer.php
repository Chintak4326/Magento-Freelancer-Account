<?php
namespace ChintakExtensions\Freelancer\Model;

use ChintakExtensions\Freelancer\Api\Data\FreelancerInterface;
...
class Freelancer extends \Magento\Framework\Model\AbstractModel implements FreelancerInterface
{
    ...
    {
        $this->_init(\ChintakExtensions\Freelancer\Model\ResourceModel\Freelancer::class);
    }
    /**
     * Get EntityId.
     *
